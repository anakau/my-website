...
export default function Home() {
  ...
  return <>
    ...
    {/* info pop‑over */}
    {showInfo && <div style={{position:'fixed',top:48,left:12,zIndex:100}}>
      <div
    ...
    >
      ...
      >
        ...
        <h3 style={{
          ...
          lineHeight:1.3,color:'#333'
        }}>
          Write anything you want to share with the world or let go.
        </h3>
        <p style={{
          margin:'0 0 32px',
          fontSize:'0.95rem',lineHeight:1.5,color:'#555'
        }}>
        ...
        <textarea
          ...
          style={{
            ...
            resize:'vertical',marginBottom:32,lineHeight:1.5
          }}
        />
        <div style={{
          textAlign:'right',fontSize:13,color:'#888',marginBottom:32
        }}>
        ...
        <button
          ...
          style={{
            ...
            color:'#d2691e',border:'1px solid #d2691e',
