...
export default function Home() {
  ...
  const [modal, setModal]         = useState({
    open: false, index: null, id: null, text: '', x: 0, y: 0
  });
  ...
  const submitModal = async () => {
    ...
    await supabase
      ...
      .update({ note: text })
      .eq('id', id);
    setModal({ open: false, index: null, id: null, text: '', x: 0, y: 0 });
  };
  ...
  return (
    <>
      ...
      {/* Write‑a‑letter bubble under the flag */}
      {modal.open && (
        <>
          <div
            onClick={() =>
          ...
          >
            ...
            />
            <h4 style={{ margin: '0 0 8px', fontWeight: 400, color: '#000' }}>
              Write a letter
            </h4>
            <div style={{ margin: '0 0 12px', color: '#000' }}>
