...
export default function Home() {
  ...
  const [dragPos, setDragPos]     = useState(null); // ghost
  ...
  // 3) Click main candle: start placing
  ...
  return (
    <>
        ...
        <div style={{ width:3000, height:2000, position:'relative' }}>
          {candles.map((c,i)=>(
            ...
            >
              ...
              {c.country_code && (
                <div style={{
                  fontSize:18, marginTop:2, lineHeight:1
                }}>
          ...
          <svg viewBox="0 0 100 100" style={{
            ...
            {[...Array(24)].map((_,i)=>{
              const angle=(i/24)*Math.PI*2,
                    inner=30, outer=inner+Math.random()*30+10,
      ...
      {/* Ghost */}
      {isPlacing && dragPos && (
        <img src="/candle.gif" alt="Ghost" style={{
          position:'fixed',
      ...
      {modal.open && (
        <>
          ...
          <div onClick={e=>e.stopPropagation()} style={{
            ...
            <h4 style={{margin:'0 0 8px',fontWeight:400,color:'#000'}}>Write a letter</h4>
            <div style={{margin:'0 0 12px',color:'#000'}}>This cannot be deleted</div>
            <textarea
              ref={textareaRef}
              rows={4}
            ...
            <div style={{
              ...
              <button
                onClick={()=>{
                  // focus text area so user can pull up system emoji
